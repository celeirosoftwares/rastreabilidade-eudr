            ...
            <div className="space-y-4">
              <Field label="Nome da propriedade *">
                <input name="name" value={form.name} onChange={handleChange}
                  placeholder="Ex: Fazenda Boa Vista" required className={inputClass} />
              </Field>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Field label="Município">
                  <input name="municipality" value={form.municipality} onChange={handleChange}
                    placeholder="Ex: Patrocínio" className={inputClass} />
                </Field>
              </div>

              <Field label="Número do CAR">
                <input name="car_number" value={form.car_number} onChange={handleChange}
                  placeholder="Ex: MG-3150570-..." className={inputClass} />
              </Field>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              <Field label="CPF ou CNPJ *">
                <input name="document_id" value={form.document_id} onChange={handleChange}
                  placeholder="000.000.000-00" required className={inputClass} />
              </Field>
            </div>
          </section>
...
const inputClass = 'w-full bg-[#0f1a0f] border border-[#2d3d2d] rounded-lg px-4 py-2.5 text-white placeholder-[#3d5a3d] focus:outline-none focus:border-[#4caf50] transition-colors text-sm'
